<div class="pagetitle mb-0 pb-2">
    <h1 style="color: #1a4d80; font-weight: 700;">Tambah Fasilitas</h1>
    <nav>
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"><a href="<?= BASE_URL ?>admin" style="color: #2b78e4;">Home</a></li>
            <li class="breadcrumb-item"><a href="<?= BASE_URL ?>admin/fasilitas">Fasilitas</a></li>
            ...
            <div class="card shadow border-0" style="border-top: 4px solid #1a4d80 !important; border-radius: 8px;">
                <div class="card-body p-5">
                    ...
                    <h5 class="card-title text-center mb-4" style="color: #1a4d80; font-family: 'Nunito', sans-serif;">
                        <i class="bi bi-building-add fs-1 d-block mb-2 text-primary"></i>
                    ...
                    <form action="<?= BASE_URL; ?>admin/simpanFasilitas" method="POST">
                        ...
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" id="nama_fasilitas" name="nama_fasilitas" placeholder="Nama Fasilitas" required style="border-color: #dee2e6;">
                            <label for="nama_fasilitas">Nama Fasilitas (Contoh: Laboratorium Komputer 1)</label>
                        </div>
                        ...
                        <div class="form-floating mb-4">
                            ...
                            <label for="deskripsi">Deskripsi & Spesifikasi Fasilitas</label>
                        </div>

                        <div class="d-flex justify-content-between mt-5">
                            <a href="<?= BASE_URL; ?>admin/fasilitas" class="btn btn-outline-secondary px-4 py-2 rounded-pill">
